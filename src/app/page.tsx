...
export default function PoleGame() {
  ...
  const factoryReset = () => {
    if (
      confirm(
        "УВАГА! Це видалить ВСІ ваші питання і відновить стандартні. Ви впевнені?",
      )
    ) {
  ...
  const handleAnswer = (idx: number) => {
    ...
    if (idx === battleData.question.correctIndex) {
      ...
      const nextPlayer = isAttackerTurn
